...
export const LoginPage: React.FC = () => {
  ...
  const demoAccounts = [
    { email: 'superadmin@kavan.com', role: 'Super Admin', pass: 'Admin@123' },
    { email: 'admin@kavan.com', role: 'Tenant Admin', pass: 'Admin@123' },
    { email: 'manager@kavan.com', role: 'Manager', pass: 'Manager@123' },
    { email: 'employee@kavan.com', role: 'Employee', pass: 'Employee@123' },
    { email: 'dev@kavan.com', role: 'Developer', pass: 'Dev@123' },
    { email: 'security@kavan.com', role: 'Security Admin', pass: 'Sec@123' },
  ];
          ...
          <div className="mt-4 w-full grid grid-cols-1 gap-2 animate-in slide-in-from-top-2">
            {demoAccounts.map(acc => (
              ...
              >
                ...
                <span className="text-muted-foreground ml-2">{acc.email} ({acc.pass})</span>
              </Button>
            ))}
          </div>
        )}
